export const ENABLE_GOOGLE_DRIVE =
  process.env.NEXT_PUBLIC_ENABLE_GOOGLE_DRIVE === "true";

export const ENABLE_DRIVE_SYNC =
  process.env.NEXT_PUBLIC_ENABLE_DRIVE_SYNC === "true";

export const ENABLE_DRIVE_ATTACHMENTS =
  process.env.NEXT_PUBLIC_ENABLE_DRIVE_ATTACHMENTS === "true";
